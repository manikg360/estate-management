...
<div class="row">
        <div class="col m6 offset-m3 signup">
            <div class="user">
    <h1 style = "text-align: center;color: #3f51b5 !important;">Register</h1>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <?= $form->field($model, 'confirm_password')->passwordInput(['placeholder' => 'Confirm Password','class'=>'form-control signup1'])->label(false); ?>
                <?= $form->field($model,'usertype')->checkbox()->label('Register as Owner');?>
                <div class="form-group">
                    <?= Html::submitButton('Register', ['class' => 'btn btn-primary', 'style'=>'margin-top:30px;','name' => 'signup-button']) ?>
                </div>
